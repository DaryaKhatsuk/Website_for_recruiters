...
from .views import error_404, error_500, homepage_view, notes_view, note_view, note_form_view, note_update_view, informs_view, companies_view, company_view, \
    company_form_view, company_update_view, vacancies_view, vacancy_view, vacancy_form_view, vacancy_update, emails_view, email_view, \
...
urlpatterns = [
    ...
    path('companies/company_<int:id_company>/', company_view, name='company'),
    path('companies/company_create/', company_form_view, name='company_form'),
    path('companies/company_update_<int:id_company>/', company_update_view, name='company_update'),
    ...
    path('vacancies/vacancy_update_<int:id_vacancy>/', vacancy_update, name='vacancy_update'),

    # path('emails/', emails_view, name='emails'),
    path('emails/<int:id_email>/', email_view, name='email'),
    path('emails/email_create/', email_form_view, name='email_form'),

    # path('candidates/', candidates_view, name='candidates'),
    path('candidates/<int:id_candidate>/', candidate_view, name='candidate'),
    path('candidates/candidate_create/', candidate_form_view, name='candidate_form'),
    path('candidates/candidate_update_<int:id_note>/', candidate_update, name='candidate_update'),
